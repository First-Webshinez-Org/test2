<div class="pos-tab-content">
    ...
    <div class="row">
        ...
        <div class="col-sm-4">
            <div class="form-group">
                <div class="checkbox">
                  <label>
                    {!! Form::checkbox('enable_variation', 1, $business->enable_variation, 
                    [ 'class' => 'input-icheck']); !!} {{ __( 'lang_v1.enable_variation' ) }}
                  </label>
                </div>
            </div>
        </div>
        ...
        <div class="col-sm-4">
            <div class="form-group">
                <div class="checkbox">
                  <label>
                    {!! Form::checkbox('enable_product_code', 1, $business->enable_product_code, [ 'class' => 'input-icheck', 'id' => 'enable_product_code']); !!} {{ __( 'lang_v1.enable_product_code' ) }}
                  </label>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-sm-4">
            <div class="form-group">
                {!! Form::label('sku_size', __('lang_v1.sku_size') . ':') !!}
                 {!! Form::number('common_settings[sku_size]', !empty($common_settings['sku_size']) ? $common_settings['sku_size'] : 4, ['class' => 'form-control', 'min' => 4, 'max' => 13]); !!}
            </div>
        </div>
