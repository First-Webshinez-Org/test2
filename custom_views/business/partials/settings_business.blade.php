<div class="pos-tab-content active">
    <div class="row">
        ...
        <div class="col-sm-4">
         ...
         <div class="col-sm-4">
        <div class="form-group">
            {!! Form::label('default_commission_percent', __('business.default_commission_percent') . ':*') !!} @show_tooltip(__('tooltip.default_commission_percent'))
            <div class="input-group">
                <span class="input-group-addon">
                    <i class="fa fa-plus-circle"></i>
                </span>
                {!! Form::text('default_commission_percent', @num_format($business->default_commission_percent), ['class' => 'form-control input_number']); !!}
            </div>
        </div>
    </div>
    </div>
