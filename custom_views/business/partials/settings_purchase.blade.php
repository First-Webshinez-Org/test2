...
<div class="clearfix"></div>
    ...
    <div class="col-sm-6">
        <div class="form-group">
            <div class="checkbox">
                <label>
                {!! Form::checkbox('enable_imei_number', 1, $business->enable_imei_number , [ 'class' => 'input-icheck', 'id' => 'enable_imei_number']); !!} {{ __( 'lang_v1.enable_imei_number' ) }}
                </label>
              @show_tooltip(__('lang_v1.tooltip_enable_imei_number'))
            </div>
        </div>
    </div>
    ...
    <div class="col-sm-6">
        <div class="form-group">
            <div class="checkbox">
                <label>
                {!! Form::checkbox('enable_commission_percent', 1, $business->enable_commission_percent , [ 'class' => 'input-icheck', 'id' => 'enable_commission_percent']); !!} {{ __( 'lang_v1.enable_commission_percent' ) }}
                </label>
              @show_tooltip(__('lang_v1.tooltip_enable_commission_percent'))
            </div>
        </div>
    </div>
