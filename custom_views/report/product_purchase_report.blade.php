                    ...
                    id="product_purchase_report_table">
                        ...
                        <tfoot>
                            <tr class="bg-gray font-17 footer-total text-center">
                                ...
                                <td>
                                    <span class="display_currency" id="footer_purchase_discount_amount" data-currency_symbol ="true"></span>
                                </td>
                                <td>
                                    <span class="display_currency" id="footer_purchase_tax" data-currency_symbol ="true"></span>
                                </td>
                                <td></td>
