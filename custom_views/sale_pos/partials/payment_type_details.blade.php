		...
		<div class="col-md-8">
		  	<div class="form-group">
				...
				<div class="input-group">
				 ...
				 {!! Form::text("payment[$row_index][cheque_date]", @format_datetime('now'), ['class' => 'form-control cheque_date','id' => "cheque_date_$row_index",  'readonly', 'required']); !!}
				</div>
		  	</div>
		</div>
		<div class="col-md-4">
			<div class="form-group">
				<div class="checkbox">
					<label>
						<br>
					{!! Form::checkbox("payment[$row_index][cheque_cleared]", 1, false, 
					[ 'class' => 'input-icheck', 'id' => 'payment[$row_index][cheque_cleared]']); !!} {{ __('lang_v1.yes_cleared') }}
					</label>
				</div>
			</div>
		</div>
