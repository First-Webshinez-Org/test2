...
<div class="row">
	...
	@if(!empty($variations))
		<div class="col-sm-4" id="product_variation_div">
			{!! Form::select('variation', $variations, null, ['id' => 'product_variation', 'class' => 'select2', 'name' => null, 'style' => 'width:100% !important']) !!}
		</div>
	@endif
