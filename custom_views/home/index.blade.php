        ...
        @if($is_admin)
            ...
            <div class="row toggle-flex">
                ...
                <div class="button-toggler">
                    <button class="btn btn-primary" id="toggler">|||</button>
                </div>
            </div>
        	<!-- toggle button end -->
    	   
            <!-- grid of chart and cards start -->
            <div class="home-chart-card">
                    <!-- sales chart comment -->
                    @if (!empty($all_locations))
                    <!-- sales chart start -->
                        <div class="row chart-flex-1">
                            <div class="col-sm-12">
                    ...
                    <div class="row flex-col">
                        <!-- /.col -->
                        <div class="col-md-12 col-xs-12 col-custom">
                        <!-- <div class="col-md-12 col-sm-6 col-xs-12 col-custom"> -->
                            <div class="col-md-9 info-box info-box-new-style justify-between" id="total-sales-box">
                                <div class="col-md-8 info-box-content">
                                    ...
                                    <span class="info-box-number total_sell">৳ 0.00</span>
                                </div>

                                <span class="info-box-icon bg-aqua ml-15"><i class="ion ion-ios-cart-outline"></i></span>
                                <!-- /.info-box-content -->
                            </div>
                            <!-- /.info-box -->
                        </div>
                        <div class="col-md-12 col-xs-12 col-custom">
                        <!-- <div class="col-md-12 col-sm-6 col-xs-12 col-custom"> -->
                            <div class="col-md-8 info-box info-box-new-style justify-between" id="net-box">
                                <div class="col-md-8 info-box-content">
                                ...
                                <span class="info-box-icon bg-green ml-15"><i class="ion ion-ios-paper-outline"></i></span>
                                <!-- /.info-box-content -->
                            </div>
                            <!-- /.info-box -->
                        </div>
                        <div class="col-md-12 col-xs-12 col-custom">
                        <!-- <div class="col-md-12 col-sm-6 col-xs-12 col-custom"> -->
                            <div class="col-md-8 info-box info-box-new-style justify-between" id="invoice-due-box">
                                <div class="col-md-8 info-box-content">
                                ...
                                <span class="info-box-icon bg-yellow ml-15"><i class="ion ion-ios-paper-outline"></i><i class="fa fa-exclamation"></i></span>
                                <!-- /.info-box-content -->
                            </div>
                            <!-- /.info-box -->
                        </div>
                        ...
                        <div class="col-md-12 col-xs-12 col-custom">
                        <!-- <div class="col-md-12 col-sm-6 col-xs-12 col-custom"> -->
                            <div class="col-md-8 info-box info-box-new-style justify-between" id="total-sell-return-box">
                                <div class="col-md-8 info-box-content">
                                ...
                                <span class="info-box-icon bg-red text-white ml-15"><i class="fas fa-exchange-alt"></i></span>
                                <!-- /.info-box-content -->
            ...
            <div class="row bottom-cards">
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12 col-custom">
                        <div class="col-md-8 info-box info-box-new-style justify-between" id=purchase-due-box>
                            ...
                            <span class="info-box-icon bg-green ml-15"><i class="fa fa-dollar"></i><i class="fa fa-exclamation"></i></span>
                            <!-- /.info-box-content -->
                        </div>
                        <!-- /.info-box -->
                    </div>
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12 col-custom">
                        <div class="col-md-8 info-box info-box-new-style justify-between" id="total-purchase-return-box">
                            ...
                            <span class="info-box-icon bg-yellow text-white ml-15"><i class="fas fa-undo-alt"></i></span>
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12 col-custom">
                        <div class="col-md-8 info-box info-box-new-style justify-between" id="expense-box">
                            ...
                            <span class="info-box-icon bg-red ml-15"><i class="fas fa-minus-circle"></i></span>
                            <!-- /.info-box-content -->
                        </div>
                        <!-- /.info-box -->
                    </div>
