                ...
                <div class="box-body">
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <td><span id="account_opening_balance"></span></td>
                        </tr>
                        <tr>
                            <th>@lang('lang_v1.total_debit'):</th>
                            <td><span class="footer_total_debit"></span></td>
                        </tr>
                        <tr>
                            <th>@lang('lang_v1.total_credit'):</th>
                            <td><span class="footer_total_credit"></span></td>
                        </tr>
                        <tr>
                            <th>@lang('lang_v1.total_closing_balance'):</th>
...
<script>
    ...
    function update_account_balance(argument) { 
        ...
        //         balance = __currency_trans_from_en(data.balance, true);
        //     }
        // });
        if (argument && argument.length == 0) {
            var accountBalance = $('#account_balance').text();
            $('span#account_opening_balance').text(accountBalance);
        }
        ...
        if (argument && argument.length > 0) {
            ...
            var opening_balance = $(argument[0].balance).data('orig-value') ? parseFloat($(argument[0].balance).data('orig-value')) : 0;

            var balance = $(argument[argument.length - 1].balance).data('orig-value') ? parseFloat($(argument[argument.length - 1].balance).data('orig-value')) : 0;

            $('span#account_opening_balance').text(__currency_trans_from_en(opening_balance, true));

            $('span#account_balance').text(__currency_trans_from_en(balance, true));
        }
        // dev-nu end
