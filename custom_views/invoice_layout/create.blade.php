  ...
  <div class="box box-solid">
    <div class="box-body">
      <div class="row">
        ...
        <div class="col-sm-3">
          <div class="form-group">
            {!! Form::label('item_charge_label', __('lang_v1.item_charge_label') . ':' ) !!}
            {!! Form::text('common_settings[item_charge_label]', 'Charge', ['class' => 'form-control',
              'placeholder' => __('lang_v1.item_charge_label'), 'id' => 'item_charge_label' ]); !!}
          </div>
        </div>
        ...
        <div class="col-sm-3">
          <div class="form-group">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('show_product_code', 1, false, ['class' => 'input-icheck']); !!} @lang('lang_v1.show_product_code')</label>
              </div>
          </div>
        </div>
        <div class="col-sm-3">
          <div class="form-group">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('show_charge', 1, false, ['class' => 'input-icheck']); !!} @lang('lang_v1.show_charge')</label>
              </div>
          </div>
        </div>
        <div class="col-sm-3">
