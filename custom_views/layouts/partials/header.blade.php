...
<!-- Main Header -->
  <header class="main-header no-print">
    <a href="{{route('home')}}" class="logo">  
      <span class="logo-lg"><img src="{{ asset('../../../../public/images/LogoBizzSelfWhite.png') }}" alt="Bizzself"></span> 
    ...
    <nav class="navbar navbar-static-top" role="navigation">
      ...
      <a href="{{route('home')}}" class="logo-name">  
        <span>{{ Session::get('business.name') }} <i class="fa fa-circle text-success" id="online_indicator"></i></span> 
      </a> 
      ...
      <div class="navbar-custom-menu">
        ...
        <div class="btn-group">
          <button id="header_shortcut_dropdown" type="button" class="btn btn-info dropdown-toggle btn-flat pull-left m-8 btn-sm mt-10" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          ...
          <ul class="dropdown-menu">
            ...
            @if(in_array('pos_sale', $enabled_modules))
              @can('sell.create')
                <li><a href="{{action([\App\Http\Controllers\SellPosController::class, 'create'])}}" title="@lang('sale.pos_sale')" data-toggle="tooltip" data-placement="bottom">
                  <i class="fa fa-th-large" aria-hidden="true"></i> @lang('sale.pos_sale')
                </a></li>
              @endcan
            @endif
            ...
            @can('profit_loss_report.view')
              <li>
                <button type="button" id="view_todays_profit" title="{{ __('home.todays_profit') }}" data-toggle="tooltip" data-placement="bottom" class="header-buttons">
                  <i class="fas fa-money-bill-alt" aria-hidden="true"></i> Today's Profit
                </button>
              </li>
            @endcan
            <li>
              <button id="btnCalculator" title="@lang('lang_v1.calculator')" type="button" class="popover-default hidden-xs header-buttons" data-toggle="popover" data-trigger="click" data-content='@include("layouts.partials.calculator")' data-html="true" data-placement="bottom">
