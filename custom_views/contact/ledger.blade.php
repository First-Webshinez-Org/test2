...
<div class="col-md-6 col-sm-6 col-xs-6 text-right align-right @if(!empty($for_pdf)) width-50 f-left @endif">
	...
	@if (($contact->balance - $ledger_details['total_reverse_payment']) - ($ledger_details['balance_due'] - $ledger_details['ledger_discount']) > 0)
		<tr>
			<td>@lang('lang_v1.advance_balance')</td>
			<td class="align-right">@format_currency(($contact->balance - $ledger_details['total_reverse_payment']) - ($ledger_details['balance_due'] - $ledger_details['ledger_discount']))</td>
		</tr>		
	@endif
	...
	<tr>
		...
		<td><strong>@lang('lang_v1.invoice_due')</strong></td>
	...
	<tr>
		...
		@endphp
		<td><strong>@lang('lang_v1.final_due')</strong></td>
		{{-- final_due = (advance_balance - balance_due) --}}
		<td class="align-right">@format_currency( $multiplier * (($contact->balance - $ledger_details['total_reverse_payment']) - ($ledger_details['balance_due'] - $ledger_details['ledger_discount'])))</td>
	</tr>
	</table>
</div>
