    ...
    <section class="content">
        @component('components.filters', ['title' => __('report.filters')])
            ...
            <div class="col-md-2">
                <div class="form-group">
                    <label>
                        {!! Form::checkbox('has_final_due', 1, false, ['class' => 'input-icheck', 'id' => 'has_final_due']) !!} <strong>@lang('lang_v1.final_due')</strong>
                    </label>
                </div>
            </div>
            @if ($type == 'customer')
                ...
                <table class="table table-bordered table-striped" id="contact_table">
                    ...
                    <tfoot>
                        <tr class="bg-gray font-17 text-center footer-total">
                            ...
                            <td class="footer_balance"></td>
                            <td class="footer_opening_balance"></td>
                            @if ($type == 'customer')
                                <td></td>
                                @if ($reward_enabled)
                                    <td></td>
