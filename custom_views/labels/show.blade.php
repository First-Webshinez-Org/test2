				...
				<table class="table table-bordered table-striped table-condensed" id="product_table">
					<thead>
						<tr>
							...
							@endif
							@if(request()->session()->get('business.enable_imei_number') == 1)
		...
		<div class="row">
			<div class="col-md-12">
				<table class="table table-bordered">
						...
						<td>
							...
							<div class="input-group">
								...
								<input type="text" class="form-control" 
									...
									value="{{$common_settings['label_preview_sizes']['name_size']?? '10'}}">
							</div>
						</td>
						...
						<td>
							...
							<div class="input-group">
								...
								<input type="text" class="form-control" 
									...
									value="{{$common_settings['label_preview_sizes']['variations_size']?? '10'}}">
							</div>
						</td>
						...
						<td>
							...
							<div class="input-group">
								...
								<input type="text" class="form-control" 
									...
									value="{{$common_settings['label_preview_sizes']['price_size']?? '10'}}">
							</div>
						...
						<td>
							...
							<div class="input-group">
								...
								<input type="text" class="form-control" 
									...
									value="{{$common_settings['label_preview_sizes']['business_name_size']?? '10'}}">
							</div>
						</td>
						...
						<td>
							...
							<div class="input-group">
								...
								<input type="text" class="form-control" 
									...
									value="{{$common_settings['label_preview_sizes']['packing_date_size']?? '10'}}">
							</div>
						</td>
								...
								<div class="input-group">
      							<div class="input-group-addon"><b>@lang( 'lang_v1.size' )</b></div>
									<input type="text" class="form-control" 
										...
										value="{{$common_settings['label_preview_sizes']['lot_number_size']?? '10'}}">
								</div>
							@endif
						</td>
								...
								<div class="input-group">
      							<div class="input-group-addon"><b>@lang( 'lang_v1.size' )</b></div>
									<input type="text" class="form-control" 
										...
										value="{{$common_settings['label_preview_sizes']['exp_date_size']?? '10'}}">
								</div>
							@endif
						</td>						
					</tr>
					<tr>
						<td>
							<div class="checkbox">
							    <label>
							    	<input type="checkbox" checked name="print[custom_field_label]" value="1"> <b>@lang( 'lang_v1.custom_field' )</b>
							    </label>
							</div>
							...
							<div class="input-group">
      							<div class="input-group-addon"><b>@lang( 'lang_v1.size' )</b></div>
								<input type="text" class="form-control" 
									name="print[custom_field_size]" 
									value="{{$common_settings['label_preview_sizes']['custom_field_size']?? '10'}}">
							</div>
						</td>
						...
						<td>
							<div class="checkbox">
							    <label>
							    	<input type="checkbox" checked name="print[custom_field_value_label]" value="1"> <b>@lang( 'lang_v1.custom_field_value' )</b>
							    </label>
							</div>
							<div class="input-group">
      							<div class="input-group-addon"><b>@lang( 'lang_v1.value' )</b></div>
								<input type="text" class="form-control" 
									name="print[custom_field_value]" 
						...
						<td>
							@if(request()->session()->get('business.enable_imei_number') == 1)
								...
								<div class="checkbox">
								    <label>
								    	<input type="checkbox" checked name="print[imei_number]" value="1"> <b>@lang( 'lang_v1.print_imei_number' )</b>
								    </label>
								</div>
								...
								<div class="input-group">
      							<div class="input-group-addon"><b>@lang( 'lang_v1.size' )</b></div>
									<input type="text" class="form-control" 
										name="print[imei_number_size]" 
										value="{{$common_settings['label_preview_sizes']['imei_number_size']?? '10'}}">
								</div>
							@endif
						</td>
					</tr>
								...
								<td>
									...
									<div class="input-group-addon"><b>@lang( 'lang_v1.size' )</b></div>
										<input type="text" class="form-control" 
											...
											value="{{ $common_settings['label_preview_sizes'][$field_name . '_size'] ?? '10' }}">
									</div>
								</td>
								@if ($c % 4 == 0)
									</tr>
				...
				<div class="text-right">
					<button type="button" class="btn btn-primary" id="labelSizeSave">Save</button>
				</div>
			</div>
