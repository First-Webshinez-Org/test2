		...
		<div class="col-md-8">
		  <div class="form-group">
			...
			<div class="input-group">
			  ...
			  {!! Form::text('cheque_date', $payment_line->cheque_date ? @format_datetime($payment_line->cheque_date) : @format_datetime('now'), ['class' => 'form-control cheque_date', 'readonly', 'required']); !!}
			</div>
		  </div>
		</div>
		<div class="col-md-4">
			<div class="form-group">
				<div class="checkbox">
					<label>
						<br>
					{!! Form::checkbox('cheque_cleared', 1, $payment_line->cheque_cleared == 1 ? true : false, 
					[ 'class' => 'input-icheck', 'id' => 'cheque_cleared']); !!} {{ __('lang_v1.yes_cleared') }}
					</label>
				</div>
			</div>
		</div>
