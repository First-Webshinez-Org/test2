...
<div>
    <div class="col-md-2">
        <div class="form-group">
            <label>
                {!! Form::checkbox('add_in_print', 1, true, ['class' => 'input-icheck', 'id' => 'add_in_print']) !!} <strong>@lang('lang_v1.add_in_print')</strong>
            </label>
        </div>
    </div>
    <div class="print_stock_table_part" id="print_stock_table_part">
        <div class="row">
            <div class="col-md-12">
                    ...
                    <tr>
                        ...
                        <td>
                            <span class="display_currency" data-is_quantity="true">
                                {{$stock_details['total_opening_stock']}}
                            </span>
                            {{ $stock_details['unit'] }}
                        </td>
                    </tr>
                ...
                <table class="table table-condensed">
                    <tr>
                        ...
                        <td>
                            ...
                            {{ $stock_details['unit'] }}
                            @if ($stock_details['units_details'])
								@foreach ($stock_details['units_details'] as $item)
									<br>
									<span class="display_currency" data-is_quantity="true">
										{{ $stock_details['current_stock'] / $item->base_unit_multiplier }} 
									</span>
									{{ $item->actual_name }}
								@endforeach
                            @endif
