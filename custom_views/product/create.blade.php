...
<section class="content">
    ...
    <div class="row">
        ...
        @if(session('business.enable_product_code'))
        <div class="col-sm-4">
            <div class="form-group">
                {!! Form::label('product_code', __('product.product_code') . ':') !!}
                {!! Form::text('product_code', null, ['class' => 'form-control',
                'placeholder' => __('product.product_code')]); !!}
            </div>
        </div>
        @endif
    ...
    <div class="row">
        ...
        <div class="form-group col-sm-12" id="product_form_part">
            @include('product.partials.single_product_form_part', ['profit_percent' => $default_profit_percent, 'commission_percent' => $default_commission_percent])
        </div>

        <input type="hidden" id="variation_counter" value="1">
        <input type="hidden" id="default_profit_percent" value="{{ $default_profit_percent }}">
        <input type="hidden" id="default_commission_percent" value="{{ $default_commission_percent }}">
