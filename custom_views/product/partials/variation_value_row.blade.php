...
<tr @if(!empty($variation_value_id)) 
    ...
    <td class="{{$class}}">
        <div class="input-group">
            {!! Form::text($name . '[' . $variation_index . '][variations][' . $value_index . '][commission_percent]', $commission_percent, ['class' => 'form-control input-sm variable_commission_percent input_number', 'required']); !!}
            @if($value_index == 0)
                <span class="input-group-btn">
