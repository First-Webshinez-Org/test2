<div class="col-sm-12"><br>
	...
	<div class="col-sm-12">
		...
		<div class="col-sm-12 col-sm-offset-4">
			<div class="col-sm-2">
				{!! Form::label('comission', __('product.commission_percent')) .":" !!}
				{!! Form::text('commission_percent', @num_format($commission_percent), ['class' => 'form-control input-sm input_number mousetrap', 'id' => 'commission']) !!}
			</div>
			<div class="col-sm-2">
...
<script type="text/javascript">
	$(document).ready(function(){
	    ...
	    function update_net_total_amount() {
	    	...
	    	//Set selling price.
	    	var commission = __read_number($('input#commission'), false);
	    	var selling_price_com = __substract_percent(selling_price, commission);
	    	var selling_price_com_inc_tax = __substract_percent(selling_price_com, tax_rate);
	    	__write_number($('input#selling_price'), selling_price_com);
	    	__write_number($('input#selling_price_inc_tax'), selling_price_com_inc_tax);
	    }
	    ...
	    $(document).on('change', 'input#commission', function(){
	    	update_net_total_amount();
	    });
