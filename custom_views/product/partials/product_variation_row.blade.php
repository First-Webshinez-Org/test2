    ...
    <td>
        <table class="table table-condensed table-bordered blue-header variation_value_table">
            ...
            <tr>
                ...
                <th class="col-md-3"><button type="button" class="btn btn-success btn-xs add_variation_value_row">+</button></th>
            </tr>
            </thead>
            ...
            <tr>
                ...
                <td class="{{$class}} col-md-4">
                    <div class="width-50 f-left custom-padding">
                        <div class="input-group">
                            ...
                            <span class="input-group-btn">
                                <button type="button" class="btn btn-default bg-white btn-flat apply-all btn-sm p-5-5" data-toggle="tooltip" title="@lang('lang_v1.copy_all')" data-target-class=".variable_dpp"><i class="fas fa-check-double"></i></button>
                            </span>
                        </div>
                    </div>
                ...
                <td class="{{$class}}">
                    <div class="input-group">
                        {!! Form::text('product_variation[' . $row_index .'][variations][0][commission_percent]', $commission_percent, ['class' => 'form-control input-sm variable_commission_percent input_number', 'required']); !!}

                        <span class="input-group-btn">
                            <button type="button" class="btn btn-default bg-white btn-flat apply-all btn-sm p-5-5" data-toggle="tooltip" title="@lang('lang_v1.apply_all')" data-target-class=".variable_commission_percent"><i class="fas fa-check-double"></i></button>
                        </span>
                    </div>
                </td>
                @endif
                ...
                <td class="{{$class}} col-md-1">
                    <div class="input-group">
                        ...
                        <!-- selling price copy -->
                        <span class="input-group-btn">
                            <button type="button" class="btn btn-default bg-white btn-flat apply-all btn-sm p-5-5" data-toggle="tooltip" title="@lang('lang_v1.copy_all')" data-target-class=".variable_dsp"><i class="fas fa-check-double"></i></button>
                        </span>
                    </div>
                </td>
                <td class="col-md-3">{!! Form::file('variation_images_' . $row_index .'_0[]', ['class' => 'variation_images', 
                    'accept' => 'image/*', 'multiple', 'style' => 'width: 100%;']); !!}</td>
                <td>
