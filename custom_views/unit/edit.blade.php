  ...
  <div class="modal-content">
    ...
    <div class="modal-body">
      <div class="row">
        ...
        <div class="form-group col-sm-12">
          @foreach ($mother_units as $item)
            {{-- @if ($unit->mother_unit_id == $item['id'])
                
            @endif --}}
              <label class="m-0">
                  {!! Form::radio('mother_unit_id', $item['id'], $item['id'] == $unit->mother_unit_id, ['class' => 'toggler', 'required' => 'required']) !!} {{ $item['name'] }}
              </label>
          @endforeach 
        </div>
        <div class="form-group col-sm-12">
...
<script src="{{ asset('js/pos.js?v=' . $asset_v) }}">

  // var motherUnits = document.getElemetn
