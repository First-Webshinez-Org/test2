...
return [
    ...
    */
    ...
    'commission_percent' => "Default commission margin for the product. <br><small class='text-muted'>(<i>You can manage default commission margin in Business Settings.</i>)</small>",
    ...
    'default_commission_percent' => "Default commission margin of a product. <br><small class='text-muted'>Used to calculate selling price based on purchase price entered.<br/> You can modify this value for indivisual products while adding</small>",
