...
use App\Http\Controllers\MotherUnitController; // (dev_ma)
...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu', 'CheckUserLogin'])->group(function () {
    ...
    Route::resource('mother-units', MotherUnitController::class); // (dev_ma)
    ...
    Route::get('/save_preview_size', [LabelsController::class, 'savePreviewSize']);
    ...
    Route::get('/reports/imei-report', [ReportController::class, 'getImeiReport2']);
    Route::get('/reports/cheque-report', [ReportController::class, 'getChequeReport2']);
    ...
    Route::get('/payment/{id}/cheque', [TransactionPaymentController::class, 'showChequePayment']);
...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone'])->group(function () {
    ...
    Route::get('/reports/imei-report/{id}', [ReportController::class, 'show']);
