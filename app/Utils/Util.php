...
class Util
{
    ...
    public function getSubUnits($business_id, $unit_id, $return_main_unit_if_empty = false, $product_id = null)
    {
        ...
        if (($return_main_unit_if_empty && count($unit->sub_units) == 0)) {
            $sub_units[$unit->id] = [
                ...
                'mother_unit_id' => $unit->mother_unit_id,
            ];
    ...
    public function getMotherUnits($business_id)
    {
        $mother_unit = MotherUnit::where('business_id', $business_id)->get()->toArray();
