...
class BusinessUtil extends Util
{
    ...
    public function createNewBusiness($business_details)
    {
        ...
        $business_details['default_commission_percent'] = 25;
    ...
    /**
     * Return the default setting for the report.
     *
     * @return array
     */
    public function defaultReportSettings()
    {
        return ['enable_profit_loss_report' => '1', 'enable_purchase_n_sale' => '1', 'enable_tax_report' => '1', 'enable_supplier_n_customer_report' => '1', 'enable_customer_groups_report' => '1', 'enable_stock_report' => '1', 'enable_stock_adjustment_report' => '1', 'enable_trending_products' => '1', 'enable_items_report' => '1', 'enable_product_purchase_report' => '1', 'enable_product_sell_report' => '1', 'enable_purchase_payment_report' => '1', 'enable_sell_payment_report' => '1', 'enable_expense_report' => '1', 'enable_register_report' => '1', 'enable_sales_representative_report' => '1', 'enable_service_staff_report' => '1', 'enable_activity_log' => '1', 'enable_cheque_report' => '1',];
    }
}
