            ...
            if ($request->hasFile('products_csv')) {
                ...
                foreach ($imported_data as $key => $value) {
                    ...
                    if ($product_array['type'] == 'single') {
                        ...
                        //Calculate commission margin
                        $commission_margin = trim($value[19]);
                        if (empty($commission_margin)) {
                            $commission_margin = $default_commission_percent;
                        } else {
                            $commission_margin = trim($value[19]);
                        }
                        $product_array['variation']['commission_percent'] = $commission_margin;
                        ...
                        //Map profit margin with variation values
                        $commission_margin = [];
                        if (! empty($commission_margin_string)) {
                            $commission_margin = array_map('trim', explode(
                                '|',
                                $commission_margin_string
                                ));
                        } else {
                            foreach ($variation_values as $k => $v) {
                                $commission_margin[$k] = $default_commission_percent;
                            }
                        }
                        ...
                        foreach ($variation_values as $k => $v) {
                            ...
                            $product_array['variation']['variations'][] = [
                                ...
                                'commission_percent' => $this->productUtil->num_f($commission_margin[$k]),
                    ...
                    foreach ($formated_data as $index => $product_data) {
                        ...
                        if ($product->type == 'single') {
                            $this->productUtil->createSingleProductVariation(
                                ...
                                $variation_data['commission_percent'],
