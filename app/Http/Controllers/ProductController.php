...
class ProductController extends Controller
{
    ...
    public function create()
    {
        ...
        $default_commission_percent = request()->session()->get('business.default_commission_percent');
        ...
        return view('product.create')
            ->with(compact('categories', 'brands', 'units', 'taxes', 'barcode_types', 'default_profit_percent','default_commission_percent', 'tax_attributes', 'barcode_default', 'business_locations', 'duplicate_product', 'sub_categories', 'rack_details', 'selling_price_group_count', 'module_form_parts', 'product_types', 'common_settings', 'warranties', 'pos_module_data'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if (empty($product_details['product_code'])) {
            ...
            if ($product->type == 'single') {
                $this->productUtil->createSingleProductVariation($product->id, $product->sku, $request->input('single_dpp'), $request->input('single_dpp_inc_tax'), $request->input('profit_percent'),  $request->input('commission_percent'), $request->input('single_dsp'), $request->input('single_dsp_inc_tax'));
                ...
                $this->productUtil->createSingleProductVariation($product->id, $product->sku, $request->input('item_level_purchase_price_total'), $request->input('purchase_price_inc_tax'), $request->input('profit_percent'), $request->input('commission_percent'), $request->input('selling_price'), $request->input('selling_price_inc_tax'), $combo_variations);
            }
    ...
    public function edit($id)
    {
        ...
        return view('product.edit')
                ->with(compact('categories', 'brands', 'units', 'sub_units', 'taxes', 'tax_attributes', 'barcode_types', 'product', 'sub_categories', 'default_profit_percent', 'default_commission_percent', 'business_locations', 'rack_details', 'selling_price_group_count', 'module_form_parts', 'product_types', 'common_settings', 'warranties', 'pos_module_data', 'alert_quantity'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            $business_id = $request->session()->get('user.business_id');
            $product_details = $request->only(['name', 'brand_id', 'unit_id', 'category_id', 'tax', 'barcode_type', 'sku', 'product_code', 'alert_quantity', 'tax_type', 'weight', 'product_description', 'sub_unit_ids', 'preparation_time_in_minutes', 'product_custom_field1', 'product_custom_field2', 'product_custom_field3', 'product_custom_field4', 'product_custom_field5', 'product_custom_field6', 'product_custom_field7', 'product_custom_field8', 'product_custom_field9', 'product_custom_field10', 'product_custom_field11', 'product_custom_field12', 'product_custom_field13', 'product_custom_field14', 'product_custom_field15', 'product_custom_field16', 'product_custom_field17', 'product_custom_field18', 'product_custom_field19', 'product_custom_field20',]);
            ...
            $product->product_code = !empty($product_details['product_code']) ? $product_details['product_code'] : null;
            ...
            if ($product->type == 'single') {
                $single_data = $request->only(['single_variation_id', 'single_dpp', 'single_dpp_inc_tax', 'single_dsp_inc_tax', 'profit_percent','commission_percent', 'single_dsp']);
                ...
                $variation->commission_percent = $this->productUtil->num_uf(isset($single_data['commission_percent']) ? $single_data['commission_percent'] : 0);
                ...
                $variation->commission_percent = $this->productUtil->num_uf($request->input('commission_percent') ?? 0);
    ...
    public function getProductVariationFormPart(Request $request)
    {
        ...
        $commission_percent = $business->default_commission_percent;

        $action = $request->input('action');
        if ($request->input('action') == 'add') {
            if ($request->input('type') == 'single') {
                return view('product.partials.single_product_form_part')
                        ->with(['profit_percent' => $profit_percent, 'commission_percent' => $commission_percent]);
                ...
                return view('product.partials.variable_product_form_part')
                        ->with(compact('variation_templates', 'profit_percent', 'commission_percent', 'action'));
            } elseif ($request->input('type') == 'combo') {
                return view('product.partials.combo_product_form_part')
                ->with(compact('profit_percent','commission_percent', 'action'));
            }
            ...
            if ($request->input('type') == 'single') {
                ...
                return view('product.partials.variable_product_form_part')
                        ->with(compact('product_variations', 'profit_percent', 'commission_percent', 'action'));
            } elseif ($request->input('type') == 'combo') {
                $product_deatails = ProductVariation::where('product_id', $product_id)
                    ->with(['variations', 'variations.media'])
                    ->first();
                ...
                $commission_percent = $product_deatails['variations'][0]->commission_percent;

                return view('product.partials.combo_product_form_part')
                ->with(compact('combo_variations', 'profit_percent', 'commission_percent', 'action', 'variation_id'));
            }
        }
    }
    ...
    public function getVariationValueRow(Request $request)
    {
        ...
        return view('product.partials.variation_value_row')
                ->with(compact('profit_percent', 'commission_percent', 'variation_index', 'value_index', 'row_type'));
    }
    ...
    public function getProductVariationRow(Request $request)
    {
        ...
        return view('product.partials.product_variation_row')
                    ->with(compact('variation_templates', 'row_index', 'action', 'profit_percent', 'commission_percent'));
    }
    ...
    public function getVariationTemplate(Request $request)
    {
        ...
        return [
            'html' => view('product.partials.product_variation_template')
                    ->with(compact('template', 'row_index', 'profit_percent', 'commission_percent'))->render(),
            'values' => $values,
        ];
    }
    ...
    public function quickAdd()
    {
        ...
        $default_commission_percent = Business::where('id', $business_id)->value('default_commission_percent');
        ...
        return view('product.partials.quick_add_product')
                ->with(compact('categories', 'brands', 'units', 'taxes', 'barcode_types', 'default_profit_percent', 'default_commission_percent', 'tax_attributes', 'product_name', 'locations', 'product_for', 'enable_expiry', 'enable_lot', 'module_form_parts', 'business_locations', 'common_settings', 'warranties'));
    }
    ...
    public function saveQuickProduct(Request $request)
    {
        ...
        try {
            ...
            $this->productUtil->createSingleProductVariation(
                ...
                $request->input('commission_percent'),
        ...
        try {
            ...
            foreach ($products as $id => $product_data) {
                ...
                foreach ($product_data['variations'] as $key => $value) {
                    ...
                    $variation->commission_percent = $this->productUtil->num_uf(isset($value['commission_percent']) ? $value['commission_percent'] : 0);
    ...
    public function productStockHistory($id)
    {
        ...
        if (request()->ajax()) {
            ...
            $stock_details = $this->productUtil->getVariationStockDetails($business_id, $id, request()->input('location_id'), $start_date, $end_date);
            $stock_history = $this->productUtil->getVariationStockHistory($business_id, $id, request()->input('location_id'), $start_date, $end_date);
