        ...
        try {
            ...
            if (! empty($products)) {
                foreach ($products as $product) {
                    ...
                    $sell_line_arr['imei_no_line_id'] = NULL;
                    $purchase_line_arr['imei_number'] = [];
                    $purchase_line_arr['warranty_date'] = [];
                    $purchase_line_arr['imei_with_warranty'] = [];
                    
                    if (! empty($product['imei_no_line_id'])) {
                        $sell_line_arr['imei_no_line_id'] = $product['imei_no_line_id'];
                        ...
                        foreach ($product['imei_no_line_id'] as $item) {
                            ...
                            if ($purchase_line) {
                                ...
                                $purchase_line_arr['imei_number'][] = !empty($imeiNumbers) ? $imeiNumbers[$value_id] : NULL;
                                $purchase_line_arr['warranty_date'][] = !empty($warrantyDates) ?$warrantyDates[$value_id] : NULL;
                                $purchase_line_arr['imei_with_warranty'][] = $imeiWithWarranty;
                            }
                        }
                    }

                    $purchase_line_arr['imei_number'] = !empty($purchase_line_arr['imei_number']) ? serialize($purchase_line_arr['imei_number']) : NULL;

                    $purchase_line_arr['warranty_date'] = !empty($purchase_line_arr['warranty_date']) ? serialize($purchase_line_arr['warranty_date']) : NULL;

                    $purchase_line_arr['imei_with_warranty'] = !empty($purchase_line_arr['imei_with_warranty']) ? serialize($purchase_line_arr['imei_with_warranty']) : NULL;
