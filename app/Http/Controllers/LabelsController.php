...
class LabelsController extends Controller
{
    ...
    public function show(Request $request)
    {
        ...
        return view('labels.show')
            ->with(compact('products','common_settings', 'barcode_settings', 'default', 'price_groups'));
    }
        ...
        try {
            ...
            foreach ($products as $value) {
                ...
                if (! empty($value['imei_number'])) {
                    $details->imei_number = $value['imei_number'];
                }
    ...
    /**
     * 
     * Saves the print sizes for labels preview
     *
     * @return \Illuminate\Http\Response
     */
    public function savePreviewSize(Request $request)
    {
        try {
            $products = $request->get('products');
            $print = $request->get('print');

            unset($print['custom_field_value']);
            ...
            $common_settings['label_preview_sizes'] = $print;
            ...
            return ['success' => 0, 'msg' => 'Error, could not save changes.'];
        }

        return ['success' => 1, 'msg' => 'Changes saved Successfully'];
