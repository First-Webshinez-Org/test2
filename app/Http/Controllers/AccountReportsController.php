...
class AccountReportsController extends Controller
{
    ...
    public function balanceSheet()
    {
        ...
        if (request()->ajax()) {
            ...
            $start_date = ! empty(request()->input('start_date')) ? request()->input('start_date') : \Carbon::now()->format('Y-m-d');
            ...
            $day_before_start_date = \Carbon::createFromFormat('Y-m-d', $end_date)->subDay()->format('Y-m-d');
            ...
            $opening_stock = $this->transactionUtil->getOpeningClosingStock($business_id, $day_before_start_date, $location_id, true, false);
            ...
            $supplier_due = $this->transactionUtil->getCustomerSupplierDue( 
                $business_id,
                $start_date,
                $end_date,
                $location_id,
            ...
            $customer_due = $this->transactionUtil->getCustomerSupplierDue( 
                $business_id,
                $start_date,
                $end_date,
                $location_id,
