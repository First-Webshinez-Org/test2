        ...
        try {
            ...
            if (! empty($products)) {
                ...
                foreach ($products as $product) {
                    ...
                    $adjustment_line['imei_no_line_id'] = NULL;
                    $adjustment_line['imei_with_warranty'] = [];
                    ...
                    if (! empty($product['imei_no_line_id'])) {
                        ...
                        foreach ($product['imei_no_line_id'] as $item) {
                            ...
                            $adjustment_line['imei_no_line_id'] = $imei_no_line_id;      
                            ...
                            if ($purchase_line) {
                                ...
                                $adjustment_line['imei_with_warranty'][] = $imeiWithWarranty;
                    ...
                    $adjustment_line['imei_with_warranty'] = !empty($adjustment_line['imei_with_warranty']) ? serialize($adjustment_line['imei_with_warranty']) : NULL;
