    ...
    public function handle($request, Closure $next)
    {
        ...
        Menu::create('admin-sidebar-menu', function ($menu) {
            ...
            $menu->dropdown(
                __('home.dashboard'),
                function ($sub) {
                    $sub->url(action([\App\Http\Controllers\HomeController::class, 'index']), __('home.home'), ['class' => 'nav-item-custom', 'active' => request()->segment(1) == 'home']);

                    $sub->url(
                            action([\App\Http\Controllers\FinancialController::class, 'index']),
                            __('home.financial'),
                            ['class' => 'nav-item-custom', 'active' => request()->segment(1) == 'financial']
                        );

                    $sub->url(
                            action([\App\Http\Controllers\AccountsController::class, 'index']),
                            __('home.due_accounts'),
                            ['class' => 'nav-item-custom', 'active' => request()->segment(1) == 'due_accounts']
                        );

                    $sub->url(
                        action([\App\Http\Controllers\InventoryController::class, 'index']),
                        __('home.inventory'),
                        ['class' => 'nav-item-custom', 'active' => request()->segment(1) == 'inventory']
                    );
                },
                    ...
                    function ($sub) {
                        if (auth()->user()->can('user.view')) {
                            $sub->url(
                                ...
                                __('user.users'),
                                ['class' => 'nav-item-custom', 'active' => request()->segment(1) == 'users']
                            );
                        }
                        if (auth()->user()->can('roles.view')) {
                            $sub->url(
                                ...
                                __('user.roles'),
                                ['class' => 'nav-item-custom', 'active' => request()->segment(1) == 'roles']
                            );
                        }
                        if (auth()->user()->can('user.create')) {
                            $sub->url(
                                ...
                                ['class' => 'nav-item-custom', 'active' => request()->segment(1) == 'sales-commission-agents']
                            );
                        }
                    },
            ...
            //                     ['class' => 'nav-item-custom', 'active' => request()->input('type') == 'supplier']
            //                 );
            //             }
            ...
            //                     ['class' => 'nav-item-custom', 'active' => request()->input('type') == 'customer']
            //                 );
            //                 $sub->url(
            ...
            //                     ['class' => 'nav-item-custom', 'active' => request()->segment(1) == 'customer-group']
            //                 );
            //             }
            ...
            //                     ['class' => 'nav-item-custom', 'active' => request()->segment(1) == 'contacts' && request()->segment(2) == 'import']
            //                 );
            //             }
            ...
            //                     ['class' => 'nav-item-custom', 'active' => request()->segment(1) == 'contacts' && request()->segment(2) == 'map']
            //                 );
            //             }
            //         },
                    ...
                    function ($sub) {
                        if (auth()->user()->can('product.view')) {
                            $sub->url(
                                ...
                                ['class' => 'nav-item-custom', 'active' => request()->segment(1) == 'products' && request()->segment(2) == '']
                            );
                        }
                        ...
                        if (auth()->user()->can('product.create')) {
                            $sub->url(
                                ...
                                ['class' => 'nav-item-custom', 'active' => request()->segment(1) == 'products' && request()->segment(2) == 'create']
                            );
                        }
                        if (auth()->user()->can('product.create')) {
                            $sub->url(
                                ...
                                ['class' => 'nav-item-custom', 'active' => request()->segment(1) == 'update-product-price']
                            );
                        }
                        if (auth()->user()->can('product.view')) {
                            $sub->url(
                                ...
                                ['class' => 'nav-item-custom', 'active' => request()->segment(1) == 'labels' && request()->segment(2) == 'show']
                            );
                        }
                        if (auth()->user()->can('product.create')) {
                            $sub->url(
                                ...
                                ['class' => 'nav-item-custom', 'active' => request()->segment(1) == 'variation-templates']
                            );
                            $sub->url(
                                ...
                                ['class' => 'nav-item-custom', 'active' => request()->segment(1) == 'import-products']
                            );
                        }
                        if (auth()->user()->can('product.opening_stock')) {
                            $sub->url(
                                ...
                                ['class' => 'nav-item-custom', 'active' => request()->segment(1) == 'import-opening-stock']
                            );
                        }
                        if (auth()->user()->can('product.create')) {
                            $sub->url(
                                ...
                                ['class' => 'nav-item-custom', 'active' => request()->segment(1) == 'selling-price-group']
                            );
                        }
                        if (auth()->user()->can('unit.view') || auth()->user()->can('unit.create')) {
                            $sub->url(
                                ...
                                ['class' => 'nav-item-custom', 'active' => request()->segment(1) == 'units']
                            );
                            $sub->url(
                                action([\App\Http\Controllers\MotherUnitController::class, 'index']),
                                __('unit.mother_units'),
                                // ['icon' => 'fa fas fa-balance-scale', 'active' => request()->segment(1) == 'units']
                                ['class' => 'nav-item-custom', 'active' => request()->segment(1) == 'mother_units']
                            );
                        }
                        if (auth()->user()->can('category.view') || auth()->user()->can('category.create')) {
                            $sub->url(
                                ...
                                ['class' => 'nav-item-custom', 'active' => request()->segment(1) == 'taxonomies' && request()->get('type') == 'product']
                            );
                        }
                        if (auth()->user()->can('brand.view') || auth()->user()->can('brand.create')) {
                            $sub->url(
                                ...
                                ['class' => 'nav-item-custom', 'active' => request()->segment(1) == 'brands']
                            );
                        }
                        ...
                        $sub->url(
                            ...
                            ['class' => 'nav-item-custom', 'active' => request()->segment(1) == 'warranties']
                        );

                        $sub->url(
                            action([\App\Http\Controllers\ChargeController::class, 'index']),
                            __('lang_v1.charges'),
                            // ['icon' => 'fa fas fa-shield-alt', 'active' => request()->segment(1) == 'charges']
                            ['class' => 'nav-item-custom', 'active' => request()->segment(1) == 'charges']
                        );
                    },
                    ...
                    function ($sub) use ($common_settings) {
                        if (! empty($common_settings['enable_purchase_requisition']) && (auth()->user()->can('purchase_requisition.view_all') || auth()->user()->can('purchase_requisition.view_own'))) {
                            $sub->url(
                                ...
                                ['class' => 'nav-item-custom', 'active' => request()->segment(1) == 'purchase-requisition']
                            );
                        }
                        ...
                        if (! empty($common_settings['enable_purchase_order']) && (auth()->user()->can('purchase_order.view_all') || auth()->user()->can('purchase_order.view_own'))) {
                            $sub->url(
                                ...
                                ['class' => 'nav-item-custom', 'active' => request()->segment(1) == 'purchase-order']
                            );
                        }
                        if (auth()->user()->can('purchase.view') || auth()->user()->can('view_own_purchase')) {
                            $sub->url(
                                ...
                                ['class' => 'nav-item-custom', 'active' => request()->segment(1) == 'purchases' && request()->segment(2) == null]
                            );
                        }
                        if (auth()->user()->can('purchase.create')) {
                            $sub->url(
                                ...
                                ['class' => 'nav-item-custom', 'active' => request()->segment(1) == 'purchases' && request()->segment(2) == 'create']
                            );
                        }
                        if (auth()->user()->can('purchase.update')) {
                            $sub->url(
                                ...
                                ['class' => 'nav-item-custom', 'active' => request()->segment(1) == 'purchase-return']
                            );
                        }
                    },
                    ...
                    function ($sub) use ($enabled_modules, $is_admin, $pos_settings) {
                        if (! empty($pos_settings['enable_sales_order']) && ($is_admin || auth()->user()->hasAnyPermission(['so.view_own', 'so.view_all', 'so.create']))) {
                            $sub->url(
                                ...
                                ['class' => 'nav-item-custom', 'active' => request()->segment(1) == 'sales-order']
                            );
                        }
                        ...
                        if ($is_admin || auth()->user()->hasAnyPermission(['sell.view', 'sell.create', 'direct_sell.access', 'direct_sell.view', 'view_own_sell_only', 'view_commission_agent_sell', 'access_shipping', 'access_own_shipping', 'access_commission_agent_shipping'])) {
                            $sub->url(
                                ...
                                ['class' => 'nav-item-custom', 'active' => request()->segment(1) == 'sells' && request()->segment(2) == null]
                            );
                        }
                        if (in_array('add_sale', $enabled_modules) && auth()->user()->can('direct_sell.access')) {
                            $sub->url(
                                ...
                                ['class' => 'nav-item-custom', 'active' => request()->segment(1) == 'sells' && request()->segment(2) == 'create' && empty(request()->get('status'))]
                            );
                        }
                            ...
                            if (in_array('pos_sale', $enabled_modules)) {
                                if (auth()->user()->can('sell.view')) {
                                    $sub->url(
                                        ...
                                        ['class' => 'nav-item-custom', 'active' => request()->segment(1) == 'pos' && request()->segment(2) == null]
                                    );
                                }
                                ...
                                $sub->url(
                                    ...
                                    ['class' => 'nav-item-custom', 'active' => request()->segment(1) == 'pos' && request()->segment(2) == 'create']
                                );
                            }
                        }
                        ...
                        if (in_array('add_sale', $enabled_modules) && auth()->user()->can('direct_sell.access')) {
                            $sub->url(
                                ...
                                ['class' => 'nav-item-custom', 'active' => request()->get('status') == 'draft']
                            );
                        }
                        if (in_array('add_sale', $enabled_modules) && ($is_admin || auth()->user()->hasAnyPermission(['draft.view_all', 'draft.view_own']))) {
                            $sub->url(
                                ...
                                ['class' => 'nav-item-custom', 'active' => request()->segment(1) == 'sells' && request()->segment(2) == 'drafts']
                            );
                        }
                        if (in_array('add_sale', $enabled_modules) && auth()->user()->can('direct_sell.access')) {
                            $sub->url(
                                ...
                                ['class' => 'nav-item-custom', 'active' => request()->get('status') == 'quotation']
                            );
                        }
                        if (in_array('add_sale', $enabled_modules) && ($is_admin || auth()->user()->hasAnyPermission(['quotation.view_all', 'quotation.view_own']))) {
                            $sub->url(
                                ...
                                ['class' => 'nav-item-custom', 'active' => request()->segment(1) == 'sells' && request()->segment(2) == 'quotations']
                            );
                        }
                        ...
                        if (auth()->user()->can('access_sell_return') || auth()->user()->can('access_own_sell_return')) {
                            $sub->url(
                                ...
                                ['class' => 'nav-item-custom', 'active' => request()->segment(1) == 'sell-return' && request()->segment(2) == null]
                            );
                        }
                        ...
                        if ($is_admin || auth()->user()->hasAnyPermission(['access_shipping', 'access_own_shipping', 'access_commission_agent_shipping'])) {
                            $sub->url(
                                ...
                                ['class' => 'nav-item-custom', 'active' => request()->segment(1) == 'shipments']
                            );
                        }
                        ...
                        if (auth()->user()->can('discount.access')) {
                            $sub->url(
                                ...
                                ['class' => 'nav-item-custom', 'active' => request()->segment(1) == 'discount']
                            );
                        }
                        if (in_array('subscription', $enabled_modules) && auth()->user()->can('direct_sell.access')) {
                            $sub->url(
                                ...
                                ['class' => 'nav-item-custom', 'active' => request()->segment(1) == 'subscriptions']
                            );
                        }
                        ...
                        if (auth()->user()->can('sell.create')) {
                            $sub->url(
                                ...
                                ['class' => 'nav-item-custom', 'active' => request()->segment(1) == 'import-sales']
                            );
                        }
                    },
                    ...
                    function ($sub) {
                        if (auth()->user()->can('purchase.view')) {
                            $sub->url(
                                ...
                                ['class' => 'nav-item-custom', 'active' => request()->segment(1) == 'stock-transfers' && request()->segment(2) == null]
                            );
                        }
                        if (auth()->user()->can('purchase.create')) {
                            $sub->url(
                                ...
                                ['class' => 'nav-item-custom', 'active' => request()->segment(1) == 'stock-transfers' && request()->segment(2) == 'create'] 
                            );
                        }
                    },
                    ...
                    function ($sub) {
                        if (auth()->user()->can('purchase.view')) {
                            $sub->url(
                                ...
                                ['class' => 'nav-item-custom', 'active' => request()->segment(1) == 'stock-adjustments' && request()->segment(2) == null]
                            );
                        }
                        if (auth()->user()->can('purchase.create')) {
                            $sub->url(
                                ...
                                ['class' => 'nav-item-custom', 'active' => request()->segment(1) == 'stock-adjustments' && request()->segment(2) == 'create']
                            );
                        }
                    },
                ...
                $menu->dropdown(
                    ...
                    function ($sub) {
                        $sub->url(
                            ...
                            ['class' => 'nav-item-custom', 'active' => request()->segment(1) == 'expenses' && request()->segment(2) == null]
                        );
                        ...
                        if (auth()->user()->can('expense.add')) {
                            $sub->url(
                                ...
                                ['class' => 'nav-item-custom', 'active' => request()->segment(1) == 'expenses' && request()->segment(2) == 'create']
                            );
                        }
                        ...
                        if (auth()->user()->can('expense.add') || auth()->user()->can('expense.edit')) {
                            $sub->url(
                                ...
                                ['class' => 'nav-item-custom', 'active' => request()->segment(1) == 'expense-categories']
                            );
                        }
                    },
                ...
                $menu->dropdown(
                    ...
                    function ($sub) {
                        $sub->url(
                            ...
                            ['class' => 'nav-item-custom', 'active' => request()->segment(1) == 'account' && request()->segment(2) == 'account']
                        );
                        $sub->url(
                            ...
                            ['class' => 'nav-item-custom', 'active' => request()->segment(1) == 'account' && request()->segment(2) == 'balance-sheet']
                        );
                        $sub->url(
                            ...
                            ['class' => 'nav-item-custom', 'active' => request()->segment(1) == 'account' && request()->segment(2) == 'trial-balance']
                        );
                        $sub->url(
                            ...
                            ['class' => 'nav-item-custom', 'active' => request()->segment(1) == 'account' && request()->segment(2) == 'cash-flow']
                        );
                        $sub->url(
                            ...
                            ['class' => 'nav-item-custom', 'active' => request()->segment(1) == 'account' && request()->segment(2) == 'payment-account-report']
                        );
                    },
                ...
                $menu->dropdown(
                    ...
                    function ($sub) use ($enabled_modules, $is_admin) {
                        if (auth()->user()->can('profit_loss_report.view')) {
                            if (!isset(session('business.report_settings')['enable_profit_loss_report']) || session('business.report_settings')['enable_profit_loss_report'] == 1) {
                                $sub->url(
                                    ...
                                    ['class' => 'nav-item-custom', 'active' => request()->segment(2) == 'profit-loss']
                                );
                            }
                        }
                        ...
                        if (config('constants.show_report_606') == true) {
                            $sub->url(
                                ...
                                ['class' => 'nav-item-custom', 'active' => request()->segment(2) == 'purchase-report']
                            );
                        }
                        ...
                        if (config('constants.show_report_607') == true) {
                            $sub->url(
                                ...
                                ['class' => 'nav-item-custom', 'active' => request()->segment(2) == 'sale-report']
                            );
                        }
                        ...
                        if ((in_array('purchases', $enabled_modules) || in_array('add_sale', $enabled_modules) || in_array('pos_sale', $enabled_modules)) && auth()->user()->can('purchase_n_sell_report.view')) {
                            if (!isset(session('business.report_settings')['enable_purchase_n_sale']) || session('business.report_settings')['enable_purchase_n_sale'] == 1) {
                                $sub->url(
                                    ...
                                    ['class' => 'nav-item-custom', 'active' => request()->segment(2) == 'purchase-sell']
                                );
                            }
                        }

                        if (auth()->user()->can('tax_report.view')) {
                            if (!isset(session('business.report_settings')['enable_tax_report']) || session('business.report_settings')['enable_tax_report'] == 1) {
                                $sub->url(
                                    ...
                                    ['class' => 'nav-item-custom', 'active' => request()->segment(2) == 'tax-report']
                                );
                            }
                        }
                        if (auth()->user()->can('contacts_report.view')) {
                            if (!isset(session('business.report_settings')['enable_supplier_n_customer_report']) || session('business.report_settings')['enable_supplier_n_customer_report'] == 1) {
                                $sub->url(
                                    ...
                                    ['class' => 'nav-item-custom', 'active' => request()->segment(2) == 'customer-supplier']
                                );
                            }
                            if (!isset(session('business.report_settings')['enable_customer_groups_report']) || session('business.report_settings')['enable_customer_groups_report'] == 1) {
                                $sub->url(
                                    ...
                                    ['class' => 'nav-item-custom', 'active' => request()->segment(2) == 'customer-group']
                                );
                            }
                        }
                        ...
                        if (auth()->user()->can('stock_report.view')) {
                            if (!isset(session('business.report_settings')['enable_stock_report']) || session('business.report_settings')['enable_stock_report'] == 1) {
                                $sub->url(
                                    ...
                                    ['class' => 'nav-item-custom', 'active' => request()->segment(2) == 'stock-report']
                                );
                            }
                            if (session('business.enable_product_expiry') == 1) {
                                $sub->url(
                                    ...
                                    ['class' => 'nav-item-custom', 'active' => request()->segment(2) == 'stock-expiry']
                                );
                            }
                            if (session('business.enable_lot_number') == 1) {
                                $sub->url(
                                    ...
                                    ['class' => 'nav-item-custom', 'active' => request()->segment(2) == 'lot-report']
                                );
                            }
                            if (session('business.enable_imei_number') == 1) {
                                $sub->url(
                                    action([\App\Http\Controllers\ReportController::class, 'getImeiReport2']),
                                    __('lang_v1.imei_report'),
                                    // ['icon' => 'fa fas fa-hourglass-half', 'active' => request()->segment(2) == 'lot-report']
                                    ['class' => 'nav-item-custom', 'active' => request()->segment(2) == 'imei-report']
                                );
                            }

                            if (!isset(session('business.report_settings')['enable_cheque_report']) || session('business.report_settings')['enable_cheque_report'] == 1) {
                                $sub->url(
                                    action([\App\Http\Controllers\ReportController::class, 'getChequeReport2']),
                                    __('lang_v1.cheque_report'),
                                    // ['icon' => 'fa fas fa-hourglass-half', 'active' => request()->segment(2) == 'lot-report']
                                    ['class' => 'nav-item-custom', 'active' => request()->segment(2) == 'cheque_report']
                                );
                            }

                            if (in_array('stock_adjustment', $enabled_modules)) {
                                if (!isset(session('business.report_settings')['enable_stock_adjustment_report']) || session('business.report_settings')['enable_stock_adjustment_report'] == 1) {
                                    $sub->url(
                                        ...
                                        ['class' => 'nav-item-custom', 'active' => request()->segment(2) == 'stock-adjustment-report']
                                    );
                                }
                            }
                        }
                        ...
                        if (auth()->user()->can('trending_product_report.view')) {
                            if (!isset(session('business.report_settings')['enable_trending_products']) || session('business.report_settings')['enable_trending_products'] == 1) {
                                $sub->url(
                                    ...
                                    ['class' => 'nav-item-custom', 'active' => request()->segment(2) == 'trending-products']
                                );
                            }
                        }

                        if (auth()->user()->can('purchase_n_sell_report.view')) {
                            if (!isset(session('business.report_settings')['enable_items_report']) || session('business.report_settings')['enable_items_report'] == 1) {
                                $sub->url(
                                    ...
                                    ['class' => 'nav-item-custom', 'active' => request()->segment(2) == 'items-report']
                                );
                            }

                            if (!isset(session('business.report_settings')['enable_product_purchase_report']) || session('business.report_settings')['enable_product_purchase_report'] == 1) {
                                $sub->url(
                                    ...
                                    ['class' => 'nav-item-custom', 'active' => request()->segment(2) == 'product-purchase-report']
                                );
                            }

                            if (!isset(session('business.report_settings')['enable_product_sell_report']) || session('business.report_settings')['enable_product_sell_report'] == 1) {
                                $sub->url(
                                    ...
                                    ['class' => 'nav-item-custom', 'active' => request()->segment(2) == 'product-sell-report']
                                );
                            }

                            if (!isset(session('business.report_settings')['enable_purchase_payment_report']) || session('business.report_settings')['enable_purchase_payment_report'] == 1) {
                                $sub->url(
                                    ...
                                    ['class' => 'nav-item-custom', 'active' => request()->segment(2) == 'purchase-payment-report']
                                );
                            }

                            if (!isset(session('business.report_settings')['enable_sell_payment_report']) || session('business.report_settings')['enable_sell_payment_report'] == 1) {
                                $sub->url(
                                    ...
                                    ['class' => 'nav-item-custom', 'active' => request()->segment(2) == 'sell-payment-report']
                                );
                            }
                        }
                        if (in_array('expenses', $enabled_modules) && auth()->user()->can('expense_report.view')) {
                            if (!isset(session('business.report_settings')['enable_expense_report']) || session('business.report_settings')['enable_expense_report'] == 1) {
                                $sub->url(
                                    ...
                                    ['class' => 'nav-item-custom', 'active' => request()->segment(2) == 'expense-report']
                                );
                            }
                        }
                        if (auth()->user()->can('register_report.view')) {
                            if (!isset(session('business.report_settings')['enable_register_report']) || session('business.report_settings')['enable_register_report'] == 1) {
                                $sub->url(
                                    ...
                                    ['class' => 'nav-item-custom', 'active' => request()->segment(2) == 'register-report']
                                );
                            }
                        }
                        if (auth()->user()->can('sales_representative.view')) {
                            if (!isset(session('business.report_settings')['enable_sales_representative_report']) || session('business.report_settings')['enable_sales_representative_report'] == 1) {
                                $sub->url(
                                    ...
                                    ['class' => 'nav-item-custom', 'active' => request()->segment(2) == 'sales-representative-report']
                                );
                            }
                        }
                        if (auth()->user()->can('purchase_n_sell_report.view') && in_array('tables', $enabled_modules)) {
                            $sub->url(
                                ...
                                ['class' => 'nav-item-custom', 'active' => request()->segment(2) == 'table-report']
                            );
                        }
                        ...
                        if (auth()->user()->can('tax_report.view') && ! empty(config('constants.enable_gst_report_india'))) {
                            $sub->url(
                                ...
                                ['class' => 'nav-item-custom', 'active' => request()->segment(2) == 'gst-sales-report']
                            );
                            ...
                            $sub->url(
                                ...
                                ['class' => 'nav-item-custom', 'active' => request()->segment(2) == 'gst-purchase-report']
                            );
                        }

                        if (auth()->user()->can('sales_representative.view') && in_array('service_staff', $enabled_modules)) {
                            if (!isset(session('business.report_settings')['enable_service_staff_report']) || session('business.report_settings')['enable_service_staff_report'] == 1) {
                                $sub->url(
                                    ...
                                    ['class' => 'nav-item-custom', 'active' => request()->segment(2) == 'service-staff-report']
                                );
                            }
                        }

                        if ($is_admin) {
                            if (!isset(session('business.report_settings')['enable_activity_log']) || session('business.report_settings')['enable_activity_log'] == 1) {
                                $sub->url(
                                    ...
                                    ['class' => 'nav-item-custom', 'active' => request()->segment(2) == 'activity-log']
                                );
                            }
                        }
                    },
                    ...
                    function ($sub) use ($enabled_modules) {
                        if (auth()->user()->can('business_settings.access')) {
                            $sub->url(
                                ...
                                ['class' => 'nav-item-custom', 'active' => request()->segment(1) == 'business', 'id' => 'tour_step2']
                            );
                            $sub->url(
                                ...
                                ['class' => 'nav-item-custom', 'active' => request()->segment(1) == 'business-location']
                            );
                        }
                        if (auth()->user()->can('invoice_settings.access')) {
                            $sub->url(
                                ...
                                ['class' => 'nav-item-custom', 'active' => in_array(request()->segment(1), ['invoice-schemes', 'invoice-layouts'])]
                            );
                        }
                        if (auth()->user()->can('barcode_settings.access')) {
                            $sub->url(
                                ...
                                ['class' => 'nav-item-custom', 'active' => request()->segment(1) == 'barcodes']
                            );
                        }
                        if (auth()->user()->can('access_printers')) {
                            $sub->url(
                                ...
                                ['class' => 'nav-item-custom', 'active' => request()->segment(1) == 'printers']
                            );
                        }
                        ...
                        if (auth()->user()->can('tax_rate.view') || auth()->user()->can('tax_rate.create')) {
                            $sub->url(
                                ...
                                ['class' => 'nav-item-custom', 'active' => request()->segment(1) == 'tax-rates']
                            );
                        }
                        ...
                        if (in_array('tables', $enabled_modules) && auth()->user()->can('access_tables')) {
                            $sub->url(
                                ...
                                ['class' => 'nav-item-custom', 'active' => request()->segment(1) == 'modules' && request()->segment(2) == 'tables']
                            );
                        }
                        ...
                        if (in_array('modifiers', $enabled_modules) && (auth()->user()->can('product.view') || auth()->user()->can('product.create'))) {
                            $sub->url(
                                ...
                                ['class' => 'nav-item-custom', 'active' => request()->segment(1) == 'modules' && request()->segment(2) == 'modifiers']
                            );
                        }
                        ...
                        if (in_array('types_of_service', $enabled_modules) && auth()->user()->can('access_types_of_service')) {
                            $sub->url(
                                ...
                                ['class' => 'nav-item-custom', 'active' => request()->segment(1) == 'types-of-service']
                            );
                        }
                    },
